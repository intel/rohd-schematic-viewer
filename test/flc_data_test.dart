...
void main() {
  test('parses embedded netlist signal and instance attributes', () {
    ...
    expect(flc.lookupSignal('Top', 'clk')!.single.file, 'lib/src/top.dart');
    expect(flc.lookupSignal('Top', 'clk')!.single.line, 12);
    expect(
      flc.lookupInstance('Top', 'child0')!.single.file,
      'lib/src/child.dart',
    );
  });
  ...
  group('FlcData.fromJson (v5 trie)', () {
    ...
    test('returns empty FlcData when modules is null', () {
      final flc = FlcData.fromJson({'version': 5, 'files': <Object>[]});
