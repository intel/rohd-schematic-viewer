...
// Generates the gate-catalog netlist used by the schematic viewer tests.
//
// Usage:
...
const _defaultOutputPath = 'assets/gate_catalog.rohd.json';
...
Future<void> main(List<String> arguments) async {
  ...
  final synthBuilder = SynthBuilder(catalog, synthesizer);
  final json = synthesizer.generateCombinedJson(synthBuilder, catalog);
