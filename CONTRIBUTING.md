# Contributing to the ROHD Schematic Viewer

Thank you for considering contributing to the ROHD Schematic Viewer! Contributions from the community are vital to making this a successful project.

Anyone interested in participating in the ROHD Schematic Viewer program is more than welcome to help!

## Code of Conduct

The ROHD Schematic Viewer adopts the [Contributor Covenant](https://www.contributor-covenant.org/) v2.1 for the [Code of Conduct](CODE_OF_CONDUCT.md).
...
You can file an issue here: <https://github.com/intel/rohd-schematic-viewer/issues/new/choose>

### Stack Overflow

[Stack Overflow](https://stackoverflow.com/) is a great tool to ask questions and get answers from the community. Use the `rohd` and/or `rohd-schematic-viewer` tag when asking your question so that others in the community who subscribe to that tag can find and answer your question more quickly!
...
[GitHub Codespaces](https://github.com/features/codespaces) are a great feature provided by GitHub allowing you to get into a development environment based on a pre-configured container very quickly! You can use them for a limited number of hours per month for free. The ROHD Schematic Viewer has set up GitHub Codespaces so that you can immediately start running examples and developing.

The below button will allow you to create a GitHub Codespace with the ROHD Schematic Viewer already cloned and ready to roll:
...
Not every new contribution has to go directly into the ROHD or the ROHD Schematic Viewer frameworks! If you have an idea for a reusable piece of hardware, tooling, verification collateral, or anything else that helps the ROHD ecosystem but is somewhat standalone, you can make your own package that depends on ROHD. Building an ecosystem of reusable components is important to the success of ROHD. Reach out if you want some help or guidance deciding if or how you should create a new package.

## Style

Like ROHD, the ROHD Schematic Viewer follows the official Dart recommended style guides and lints. The analyzer will help ensure that your code is written consistently with the rest of ROHD.
